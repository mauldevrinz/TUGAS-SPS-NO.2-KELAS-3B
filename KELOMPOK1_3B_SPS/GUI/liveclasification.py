...
class RealTimePlot(QWidget):
    def __init__(self, title, xlabel, ylabel):
        super().__init__()
        self.figure = Figure(figsize=(3, 4))  # Ukuran grafik agar label tidak terpotong
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("LIVE RECORDING AND TRANSLATE - KELOMPOK 3")
        ...
        self.label = QLabel("LIVE RECORDING - KELOMPOK 3", self)
    ...
    def upload_to_edge_impulse(self, file_path, actor_name):
        ...
        edge_impulse_api_url = f"https://ingestion.edgeimpulse.com/api/testing/files"
        edge_impulse_api_key = "ei_4832c23a44cfcb70a6e50ef569fbdbfd6a4539600f665208" 
